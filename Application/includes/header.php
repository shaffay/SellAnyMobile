...
<head>
	...
	<!--Template style -->
	<link rel="stylesheet" type="text/css" href="assets/css/xpedia.css" />
	<!--favicon-->
	<link rel="shortcut icon" type="image/png" href="assets/assets/images/fevicon.png" />
</head>
			...
			<div class="x_top_header_right_side_wrapper float_left">
				...
				<div class="x_top_header_all_select_box_wrapper">
					<ul>
						...
						<li class="register"> <a href="register.html"><i class="fa fa-plus-circle"></i>
								&nbsp;&nbsp;register</a>
						</li>
						<li>
			...
			<div class="row">
				<div class=" col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
					<div class="hs_logo_wrapper d-none d-sm-none d-xs-none d-md-block">
						<a href="index.html">
							<img src="assets/images/logo.jpg" class="img-responsive" alt="logo" title="Logo" />
						</a>
					</div>
				</div>
							...
							<div class="drop-menu">
								<div class="cc_cart_wrapper1">
									<div class="cc_cart_img_wrapper">
										<img src="assets/images/cart_img.jpg" alt="cart_img" />
									</div>
